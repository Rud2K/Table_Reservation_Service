...
public class StoreController {
	 ...
	 * 
	 * 주어진 매장 ID와 수정할 매장 정보를 받아 해당 매장 정보를 수정하고,
	 * 수정된 정보를 반환합니다.
	 */
	@PutMapping("/{storeId}")
	@PreAuthorize("hasRole('PARTNER')")
	public ResponseEntity<Store> updateStore(@PathVariable("storeId") Long storeId, @RequestBody Store store) {
		Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
